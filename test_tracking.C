...
// s1[i]->Draw("H.gtr.beta>>h2[i]","P.gtr.dp>5&&P.gtr.dp<20 && P.cal.etottracknorm> 0.15 && P.cal.etottracknorm<0.4 && P.aero.npeSum> 0.5 && P.cal.eprtracknorm>0&&P.cal.eprtracknorm<0.15&& P.gtr.beta>0.7&&P.gtr.beta<1.3 && H.cal.etottracknorm>0.8&&H.cal.etottracknorm<1.2&& H.gtr.dp>-10&&H.gtr.dp<10 && H.gtr.beta>0.7&&H.gtr.beta<1.3  ","");//did_cut
 ...
 s1[i]->Draw("P.gtr.beta>>h1[i]", "P.hod.goodscinhit==1 && P.hod.betanotrack > 0.5 && P.hod.betanotrack < 1.4 && (P.dc.1x1.nhit + P.dc.1u2.nhit + P.dc.1u1.nhit + P.dc.1v1.nhit + P.dc.1x2.nhit + P.dc.1v2.nhit) < 21 && (P.dc.2x1.nhit + P.dc.2u2.nhit + P.dc.2u1.nhit + P.dc.2v1.nhit + P.dc.2x2.nhit + P.dc.2v2.nhit) < 21 && P.aero.npeSum > 1.0  &&P.dc.ntrack>0.","goff");  //did_cut

s1[i]->Draw("P.gtr.beta>>h2[i]", "P.hod.goodscinhit==1 && P.hod.betanotrack > 0.5 && P.hod.betanotrack < 1.4 && (P.dc.1x1.nhit + P.dc.1u2.nhit + P.dc.1u1.nhit + P.dc.1v1.nhit + P.dc.1x2.nhit + P.dc.1v2.nhit) < 21 && (P.dc.2x1.nhit + P.dc.2u2.nhit + P.dc.2u1.nhit + P.dc.2v1.nhit + P.dc.2x2.nhit + P.dc.2v2.nhit) < 21 && P.aero.npeSum > 1.0","goff"); //should_cut
 ...
 gr->SetPointError(i, 0, error1[i]);
  ...
  gr->Draw("AP*"); 
  c1->SaveAs("pdf/shms_tracking_eff.pdf");
