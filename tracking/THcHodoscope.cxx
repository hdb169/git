...
=================this file has some comments to get some output that may be helpful to understand goodscinhit==1======================
*/
...
Int_t THcHodoscope::Decode( const THaEvData& evdata )
{
  ...
  //if (evdata.GetEvNum()>1000)//===========================================================================dec13=================jan2
  // cout <<"\nhcana_event " << evdata.GetEvNum()<<endl;//==================================================dec13=================jan2
...
void THcHodoscope::TrackEffTest(void)
{
  ...
  //
  // Bool_t efftest_debug = kFALSE;//================================================================================dec13
  // Bool_t efftest_debug = kTRUE;//==============================================Jan 2
  ...
  for (Int_t ip = 0; ip < fNumPlanesBetaCalc; ip++ ){
    ...
    if (lowtemp < hitemp) {
      ...
      if (efftest_debug) cout << " lowtemp = " <<  PadPosLo[ip]<<endl;//lowtemp << endl;//===========================dec16
      if (efftest_debug) cout << " hitemp = " <<  PadPosHi[ip]<<endl ;//emp << endl;//===========================dec16
  ...
  // Bool_t xdiffTest=kTRUE;//=========================================================jan2
  //Bool_t ydiffTest=kTRUE;//=========================================================jan2
  fGoodScinHits = 0;
  ...
  if (fTrackEffTestNScinPlanes == 3 && num_good_plane_hit==3) {
    // xdiffTest=kFALSE;
    // ydiffTest=kFALSE;
    // xdiffTest=kTRUE;//==============================================================================Jan2
    //ydiffTest=kTRUE;//==============================================================================Jan2
  ...
  if (efftest_debug) cout << " GoodScinHits = " << fGoodScinHits << endl; //===================================================dec16, 2019 C.Y.



  if (efftest_debug) cout << " *****************done****************" << endl;
  //
}
//
//
