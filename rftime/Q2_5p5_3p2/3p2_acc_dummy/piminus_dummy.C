#include "header.h"
void neg_3p2dummy_7727(){
#include "gStyle.h"
  TChain *tt = new TChain("T");
  
  tt->Add("ROOTfiles/neg_3p2dummy_7727.root");

  TFile *ff = new TFile("root_yield/yield_neg_3p2dummy_7727.root","RECREATE");   
...
#include "branch.h" 
 ...
 h_dataz_cut1plus2->Draw("e,p1");
  ...
  c0->SaveAs("pdf_7727/cut0_accsub_neg_3p2dummy_7727.pdf");
  c1->SaveAs("pdf_7727/cut1_accsub_neg_3p2dummy_7727.pdf");
  c2->SaveAs("pdf_7727/cut2_accsub_neg_3p2dummy_7727.pdf");
  c3->SaveAs("pdf_7727/cut3_accsub_neg_3p2dummy_7727.pdf");
  c1plus2->SaveAs("pdf_7727/cut1plus2_accsub_neg_3p2dummy_7727.pdf");
  coin->SaveAs("pdf_7727/ctime_neg_3p2dummy_7727.pdf");
