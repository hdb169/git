...
void new_yield_neg_3p2_7735(){
  ...
  // tt->Add("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/coin_3p2neg_7735.root");
  // tt->Add("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/coin_2p2neg_7783.root");
  //tt->Add("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/coin_2p2neg_6215.root");
  tt->Add("ROOTfiles/neg_3p2_7735.root");

  //  TFile *ff = new TFile("root/neg_3p2_7735.root","RECREATE");   
  TFile *ff = new TFile("root_yield/yield_neg_3p2_7735.root","RECREATE");   
...
#include "binz.h"
  ...
  TH1D * neg = new TH1D("neg","neg",binz,loz,hiz);
  ...
  for (int kk=0; kk<nentriesD;  kk++)//original
   ...
   
    {
      ...
      mod4_pioncut = rf_pion >2.4 && rf_pion < 3.1;
      mod4_pioncut_tight = rf_pion >2.45 && rf_pion < 3.05;
  ...
  TCanvas *cneg = new TCanvas("cneg", "Counts for Neg 3p2 Run 7735", 1600, 1200);
  cneg->Divide(3,2);
  ...
  h_dataz_cut0->DrawClone("e,p1");
  h_dataz_cut0->GetXaxis()->SetTitle("zhadron");
  h_dataz_cut0->GetYaxis()->SetTitle("Counts");
  h_dataz_cut0->GetXaxis()->CenterTitle();
  h_dataz_cut0->GetYaxis()->CenterTitle();
  
  h_dataz_cut1->DrawClone("e,same");
  h_dataz_cut2->DrawClone("e,same");
  h_dataz_cut3->DrawClone("e,same");
  h_dataz_cut1plus2->DrawClone("e,same");
  h_dataz_cut1plus2->SetLineWidth(2);
  ...
  cneg->SaveAs("pdf_yield/neg_3p2_7735.pdf");
    cneg->SaveAs("pdf_yield/neg_3p2_7735.png");
...
/*
  ...
  ceff->SaveAs("pdf/pos_3p2pos_7735_eff.pdf");
  ...
  cointime_pi->SetMarkerColor(kGreen);
  ...
  ofstream txtfile ("txtfile/pos_3p2pos_7735.txt",ios::app);
  txtfile<<"pos_3p2pos_7735"<<"\t\t"<< "did =  "<<"\t"<< pcal_etot_rf->Integral() << "\t"<< "should = "<<"\t"<< pcal_etot->Integral() << "\t"<<"eff_of rf = "<<"\t"<< (pcal_etot_rf->Integral() / pcal_etot->Integral())*100 <<" % " <<endl;
  ...
  c1->SaveAs("pdf_7735/pos_3p2_7735.pdf");
  c2->SaveAs("pdf_7735/pos_3p2_7735_beta_vs_rf.pdf");
  c3->SaveAs("pdf_7735/pos_3p2_7735_aero_vs_rf.pdf");
  c4->SaveAs("pdf_7735/pos_3p2_7735_ctime.pdf");
  c5->SaveAs("pdf_7735/pos_3p2_7735_cal.pdf");
  // c6->SaveAs("pdf_7735/pos_3p2_7735_hmsshms_cuts.pdf");
  c7->SaveAs("pdf_7735/pos_3p2_7735_beta_vs_rf_nocolor.pdf");
  c8->SaveAs("pdf_7735/pos_3p2_7735_aero_vs_rf_nocolor.pdf");
  c9->SaveAs("pdf_7735/pos_3p2_7735_small_peak_under_ctimepeak.pdf");

  c10->SaveAs("pdf_7735/pos_3p2_7735_hgcer.pdf");
*/
