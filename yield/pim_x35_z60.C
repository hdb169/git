...
void pim_x35_z60(){
  //Int_t runNum = 6073;//first run num here
  gStyle->SetOptStat(1111111);
#include "gStyle.h" 
#include "bin.h"
  TChain *tt = new TChain("T");
  tt->Add("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/yield/coin_replay_production_6073_-1.root");
  tt->Add("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/yield/coin_replay_production_6081_-1.root");

  TFile *ff = new TFile("root/pim_x35_z60.root","RECREATE");   
