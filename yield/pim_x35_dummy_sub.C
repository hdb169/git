#include "header.h"
#include "bin.h"
void pim_x35_dummy_sub() {
  gStyle->SetOptStat(1111111);
  TFile *f1 = new TFile("root/pim_x35_z70.root");//, "READ");
  TFile *f2 = new TFile("root/pim_x35_z60.root");//, "READ");
  TFile *f3 = new TFile("root/pim_x35_z50.root");//, "READ");
  TFile *f4 = new TFile("root/pim_x35_z40.root");//, "READ");
  TFile *f11 = new TFile("root/pim_x35_z70_al.root");//, "READ");
  TFile *f22 = new TFile("root/pim_x35_z60_al.root");//, "READ");
  TFile *f33 = new TFile("root/pim_x35_z50_al.root");//, "READ");
  TFile *f44 = new TFile("root/pim_x35_z40_al.root");//, "READ");
  TFile *f = new TFile("root/pim_x35_z_70_60_50_40.root", "RECREATE");

  Double_t data_factor = 0.244;// dummy factor

  Double_t tot_q1 = 129.543;//D2 charge in 4 z settings
  Double_t tot_q2 = 119.755;
  Double_t tot_q3 = 109.60;
  Double_t tot_q4 = 82.56;

  //for dummy we need additional scaling by 0.244 due to the window thickness
  Double_t tot_q11 = 108.56/data_factor;//Al charge in 4 settings
  Double_t tot_q22 = 123.57/data_factor;
  Double_t tot_q33 = 149.28/data_factor;
  Double_t tot_q44 = 125.40/data_factor;


  /////////////////////////////////////////////////D2 Target///////////////////////////////////////////////////////
  TCanvas *c10 = new TCanvas("c10", "data_pim_x35",1600,1200);  
  c10->Divide(4,2);
  ...
  c10->SaveAs("pdf/pim_x35_d2_plots.pdf");
...
//////////////////////////////////////////////////YIELD  D2- YIELD DUMMY TARGET PLOT /////////////////////////////////////////
  ...
  TH1D *pim_x35_z70 = new TH1D ("pim_x35_z70", "x35_z70_D2-Al", binz, loz, hiz);
  TH1D *pim_x35_z60 = new TH1D ("pim_x35_z60", "x35_z60_D2-Al", binz, loz, hiz);
  TH1D *pim_x35_z50 = new TH1D ("pim_x35_z50", "x35_z50_D2-Al", binz, loz, hiz);
  TH1D *pim_x35_z40 = new TH1D ("pim_x35_z40", "x35_z40_D2-Al", binz, loz, hiz);

  TCanvas *c11 = new TCanvas("c11", "c11", 1600,1200);
  c11->Divide(2,2);

  c11->cd(1);
  pim_x35_z70->Add(new_h1,new_h11,1.0,-1.0);
  if(!(pim_x35_z70->GetSumw2N()>0)) pim_x35_z70->Sumw2(kTRUE);
  pim_x35_z70->Draw("e,p1");
  pim_x35_z70->SetLineColor(kBlue);
  pim_x35_z70->SetLineWidth(2);
  pim_x35_z70->SetTitle("Clean Yield for pim_x35_z70");

  c11->cd(2);
  pim_x35_z60->Add(new_h2,new_h22,1.0,-1.0);
  if(!(pim_x35_z60->GetSumw2N()>0)) pim_x35_z60->Sumw2(kTRUE);
  pim_x35_z60->Draw("e,p1");
  pim_x35_z60->SetLineWidth(2);
  pim_x35_z60->SetLineColor(kBlue);
  pim_x35_z60->SetTitle("Clean Yield for pim_x35_z60");

  c11->cd(3);
  pim_x35_z50->Add(new_h3,new_h33,1.0,-1.0);
  if(!(pim_x35_z50->GetSumw2N()>0)) pim_x35_z50->Sumw2(kTRUE);
  pim_x35_z50->Draw("e,p1");
  pim_x35_z50->SetLineWidth(2);
  pim_x35_z50->SetLineColor(kBlue);
  pim_x35_z50->SetTitle("Clean Yield  for pim_x35_z50");


  c11->cd(4);
  pim_x35_z40->Add(new_h4,new_h44,1.0,-1.0);
  if(!(pim_x35_z40->GetSumw2N()>0)) pim_x35_z40->Sumw2(kTRUE);
  pim_x35_z40->Draw("e,p1");
  pim_x35_z40->SetLineWidth(2);
  pim_x35_z40->SetLineColor(kBlue);
  pim_x35_z40->SetTitle("Clean Yield for pim_x35_z40");

  pim_x35_z70->Write();
  pim_x35_z60->Write();
  pim_x35_z50->Write();
  pim_x35_z40->Write();
  c11->SaveAs("pdf/pim_x35_al_plots.pdf");
