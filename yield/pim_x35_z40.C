...
#include "bin.h"
  ...
  // TFile *f= new TFile(Form("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/coin_replay_production_%d_-1.root",runNum));
     tt->Add("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/yield/coin_replay_production_6091_-1.root");
     tt->Add("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/yield/coin_replay_production_6093_-1.root");
     tt->Add("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/yield/coin_replay_production_6096_-1.root");

  TFile *ff = new TFile("root/pim_x35_z40.root","RECREATE");   
