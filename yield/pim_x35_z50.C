...
void pim_x35_z50(){
  //Int_t runNum = 6088;//first run num here
...
#include "bin.h"
  ...
  // TFile *f= new TFile(Form("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/coin_replay_production_%d_-1.root",runNum));
     tt->Add("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/yield/coin_replay_production_6088_-1.root");
     tt->Add("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/yield/coin_replay_production_6089_-1.root");
     tt->Add("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/yield/coin_replay_production_6090_-1.root");

     TFile *ff = new TFile("root/pim_x35_z50.root","RECREATE");   
