...
#include "bin.h"
  TChain *tt = new TChain("T");
     tt->Add("/lustre/expphy/volatile/hallc/spring17/hdbhatt/group/ROOTfiles/yield/coin_replay_production_6046_-1.root");

  TFile *ff = new TFile("root/pip_x35_z50_al.root","RECREATE");   
...
#include "setbranch.h"
  ...
  #include "plot.h"
  h_dataz_final->Write();
  c1->SaveAs("pdf/pip_x35_z50_al.pdf");
