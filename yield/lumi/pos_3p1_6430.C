...
#include "gStyle.h"
  ...
  gStyle->SetOptStat(0);
  tt->Add("coin_replay_production_6430_-1.root");

  TFile *ff = new TFile("root_yield/yield_pos_3p1_6430.root","RECREATE");   
...
#include "branch.h" 
  ...
  Double_t rf_piona, mod4pioncuta;
  ////////////////To find ctime peak////////////////
  ...
  for (int ac=0; ac<nentriesD;  ac++)//original
   ...
   
    {
      ...
      rf_piona = (fmod(-prftdctime+phodfphitstime+ offsetrf ,4.008));
      
      mod4_pioncuta = rf_pion > rfmin && rf_pion < rfmax;

     

      accsub_cut = paero>3.0 && pcalepr < eprmax  && pcaletottrack < 0.6 && hcaletottrack > 0.8 && hcaletottrack < 1.2 && hdelta> -10 && hdelta < 10 && pdelta >-10 && pdelta < 20  && hcernpe > 1.5 &&  pbeta > 0.8 && pbeta < 1.2 && hbeta > 0.8 && hbeta < 1.2  && hhodstarttime ==1 && phodstarttime == 1 && hdipole==1 &&pdipole ==1 &&eventtype > 3.0  ; 
  ...
  cout<< "data Entry ="	<< h_dataz_final->GetEntries()<<endl;
  cout<< "data Int. ="	<< h_dataz_final->Integral()<<endl;

 cout<< "acc Entry ="	<< h_dataz_accfinal->GetEntries()<<endl;
  cout<< "acc Int. ="	<< h_dataz_accfinal->Integral()<<endl;
  ...
  cout<< "D2 6430 Final Good Entries & Integral = " <<  h_dataz_cutfinal->GetEntries() <<"   "<< h_dataz_cutfinal->Integral()<<endl;
  cout<< "D2 6430 All Good Entries & Integral = " <<  h_dataz_final->GetEntries() <<"   "<< h_dataz_final->Integral()<<endl;
  cout<< "D2 6430 Acc Entries & Integral = " <<  h_dataz_accfinal->GetEntries() <<"   "<< h_dataz_accfinal->Integral()<<endl;
  ...
  cfinal->SaveAs("pdf_pos_3p1/cfinal_accsub_pos_3p1_6430.pdf");
  c0->SaveAs("pdf_pos_3p1/cut0_accsub_pos_3p1_6430.pdf");
  c1->SaveAs("pdf_pos_3p1/cut1_accsub_pos_3p1_6430.pdf");
  c2->SaveAs("pdf_pos_3p1/cut2_accsub_pos_3p1_6430.pdf");
  c3->SaveAs("pdf_pos_3p1/cut3_accsub_pos_3p1_6430.pdf");
  c1plus2->SaveAs("pdf_pos_3p1/cut1plus2_accsub_pos_3p1_6430.pdf");
  coin->SaveAs("pdf_pos_3p1/ctime_pos_3p1_6430.pdf");
 ...
 rf_minus_phodfp_mod4_pi->Draw();gPad->SetGrid();
  ...
  c7->SaveAs("pdf_pos_3p1/beta_vs_rf_betadelta_pos_3p1_6430.pdf");
  c8->SaveAs("pdf_pos_3p1/aero_vs_rf_betadelta_pos_3p1_6430.pdf");
  c9->SaveAs("pdf_pos_3p1/ctime_diffcut_pos_3p1_6430.pdf");
  c10->SaveAs("pdf_pos_3p1/rftime_1d_pos_3p1_6430.pdf");
  ...
  */
  ...
  c11->SaveAs("pdf_pos_3p1/etottrack_vs_rftime_pos_3p1_6430.pdf");
  c12->SaveAs("pdf_pos_3p1/prshower_vs_rftime_pos_3p1_6430.pdf");
  c13->SaveAs("pdf_pos_3p1/shower_vs_rftime_pos_3p1_6430.pdf");
  c14->SaveAs("pdf_pos_3p1/ctime_vs_rftime_pos_3p1_6430.pdf");
