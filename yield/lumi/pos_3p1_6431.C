...
#include "gStyle.h"
  ...
  gStyle->SetOptStat(0);
  tt->Add("coin_replay_production_6431_-1.root");

  TFile *ff = new TFile("root_yield/yield_pos_3p1_6431.root","RECREATE");   
...
#include "branch.h" 
 ...
 cout<< "acc Entry ="	<< h_dataz_accfinal->GetEntries()<<endl;
  ...
  cout<< "D2 6431 Final Good Entries & Integral = " <<  h_dataz_cutfinal->GetEntries() <<"   "<< h_dataz_cutfinal->Integral()<<endl;
  cout<< "D2 6431 All Good Entries & Integral = " <<  h_dataz_final->GetEntries() <<"   "<< h_dataz_final->Integral()<<endl;
  cout<< "D2 6431 Acc Entries & Integral = " <<  h_dataz_accfinal->GetEntries() <<"   "<< h_dataz_accfinal->Integral()<<endl;
  ...
  cfinal->SaveAs("pdf_pos_3p1/cfinal_accsub_pos_3p1_6431.pdf");
  c0->SaveAs("pdf_pos_3p1/cut0_accsub_pos_3p1_6431.pdf");
  c1->SaveAs("pdf_pos_3p1/cut1_accsub_pos_3p1_6431.pdf");
  c2->SaveAs("pdf_pos_3p1/cut2_accsub_pos_3p1_6431.pdf");
  c3->SaveAs("pdf_pos_3p1/cut3_accsub_pos_3p1_6431.pdf");
  c1plus2->SaveAs("pdf_pos_3p1/cut1plus2_accsub_pos_3p1_6431.pdf");
  coin->SaveAs("pdf_pos_3p1/ctime_pos_3p1_6431.pdf");
 ...
 rf_minus_phodfp_mod4_pi->Draw();gPad->SetGrid();
  ...
  c7->SaveAs("pdf_pos_3p1/beta_vs_rf_betadelta_pos_3p1_6431.pdf");
  c8->SaveAs("pdf_pos_3p1/aero_vs_rf_betadelta_pos_3p1_6431.pdf");
  c9->SaveAs("pdf_pos_3p1/ctime_diffcut_pos_3p1_6431.pdf");
  c10->SaveAs("pdf_pos_3p1/rftime_1d_pos_3p1_6431.pdf");
  ...
  */
  ...
  c11->SaveAs("pdf_pos_3p1/etottrack_vs_rftime_pos_3p1_6431.pdf");
  c12->SaveAs("pdf_pos_3p1/prshower_vs_rftime_pos_3p1_6431.pdf");
  c13->SaveAs("pdf_pos_3p1/shower_vs_rftime_pos_3p1_6431.pdf");
  c14->SaveAs("pdf_pos_3p1/ctime_vs_rftime_pos_3p1_6431.pdf");
