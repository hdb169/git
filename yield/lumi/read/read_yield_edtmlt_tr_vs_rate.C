...
void read_yield_edtmlt_tr_vs_rate()//------------------------------1
{
#include "gStyle.h"
  gStyle->SetStatX(0.9);
  gStyle->SetStatY(0.9);
  ...
  std::ifstream infile3("../txtfile_shms/shms_yield_track_edtmlt.txt");//------------------------2
  ...
  cout<<slop<<endl;
  c3->Print("pdf/yield_shms_5347_5350_edtmlt_tr_vs_rate.pdf");//---------------------------------------7
