#define NRUNS 13
void hcal_eff_xptar_cer12_aero10(){//has hgcer cut
  ofstream txtfile1("txtfile/cur_rate_charge.txt",ios::app);
  ofstream txtfile2("txtfile/hcal_neg_pcal_sh_presh.txt",ios::app);
  ofstream txtfile3("txtfile/hcal_eff_xptar_12_10.txt",ios::app);
  ofstream txtfile4("txtfile/pcal_eff_xptar_12_10.txt",ios::app);
...
#include "scaler_analysis.h"
   ...
   cc3->cd(1);gPad->SetGridx();gPad->SetGridy();
    ...
    cc3->cd(9);gPad->SetLogz();gPad->SetGridx();gPad->SetGridy();
    ...
    cc3->cd(10);gPad->SetLogz();gPad->SetGridx();gPad->SetGridy();
    ...
    txtfile3<<runs[r]<<"       "<<hmsp[r]<<"       "<<hcal_eff<<"       "<<hcal_eff_err<<endl;
    txtfile4<<runs[r]<<"       "<<shmsp[r]<<"       "<<pcal_eff<<"       "<<pcal_eff_err<<endl;
