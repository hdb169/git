...
void read_pcal_eff(){
  ...
  //2
  std::ifstream infile2("txtfile/pcal_eff_noxptar_10_8.txt");
  ...
  //3
  std::ifstream infile3("txtfile/pcal_eff_xptar_10_8.txt"); 
  ...
  //4
  std::ifstream infile4("txtfile/pcal_eff_xptar_12_8.txt"); 
  ...
  std::ifstream infile5("txtfile/pcal_eff_xptar_10_8_hms0p8_shms0p7.txt");
  ...
  std::ifstream infile6("txtfile/pcal_eff_xptar_10_8_hms0p8_shms0p8.txt");
  ...
  //7
  std::ifstream infile7("txtfile/pcal_eff_xptar_12_10.txt");
  ...
  gr4->SetTitle("Acc_hcer12_aero8_hcal0p7_pcal0p8");
  ...
  gr5->SetName("gr5");
  gr5->SetMarkerStyle(29);//21
  gr5->SetMarkerSize(1.4);
  gr5->SetTitle("Acc_hcer10_aero8_hcal0p8_pcal_0p7");
  ...
  gr6->SetTitle("Acc_hcer10_aero8_hcal0p7_pcal_0p7 (Best)");
  ...
  mg->Add(gr6);
  mg->Add(gr7);
  gr7->Draw("AP");//grlast->Draw();
  mg->Draw("AP");
  mg->Write();//Save as rootfile


  mg->SetTitle("PCAL Efficiency vs Momentum; Momentum (GeV)  ; PCAL EFF");
