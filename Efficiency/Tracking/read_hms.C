...
void read_tracking_hms(){
  ...
  //2
  std::ifstream infile2("txtfile_hms/hms_tr_eff_curr_nodelta_hit35.txt");
  ...
  //3
  std::ifstream infile3("txtfile_hms/hms_tr_eff_curr_hit35.txt");
 std::string line3;
  vector <double> run3; 
  vector <double> rate3;
  vector <double> did3;
  ...
  gr3->SetTitle("35 hits: -100< HDELTA < 100 (in Did)");
  ...
  mg->SetTitle("HMS TREfficiency; Current (uA) ; HMS TR EFF");
  ...
  mg->SaveAs("pdf/htracking_eff.pdf");
  c1->Print("pdf/htracking_eff.gif");
