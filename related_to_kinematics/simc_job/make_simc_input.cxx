...
void make_simc_input(int RunGroup = 0){
  ...
  json j_rungroup;
  {
    std::ifstream ifs("/u/group/c-csv/hdbhatt/my_analysis/kinematics/ratio_run_group_updated.json");
    ifs>>j_rungroup;
  }
  json j_fall;
  {
    std::ifstream ifs("/u/group/c-csv/hdbhatt/my_analysis/kinematics/run_list.json");
    ifs>>j_fall;
  }
  json j_spring;
  {
    std::ifstream ifs("/u/group/c-csv/hdbhatt/my_analysis/kinematics/run_list_update.json");
    ifs>>j_spring;
  }
  ...
  //D2 input file
  std::string ofs_D2_neg_inc_norad_name = "/u/group/c-csv/hdbhatt/my_analysis/simulation/simc_oct_2020_ver/simc_gfortran/infiles/csv_"+std::to_string(RunGroup)+"_D2_neg_inc_norad.inp";
  std::string ofs_D2_neg_inc_rad_name = "/u/group/c-csv/hdbhatt/my_analysis/simulation/simc_oct_2020_ver/simc_gfortran/infiles/csv_"+std::to_string(RunGroup)+"_D2_neg_inc_rad.inp";
  std::string ofs_D2_neg_exc_norad_name = "/u/group/c-csv/hdbhatt/my_analysis/simulation/simc_oct_2020_ver/simc_gfortran/infiles/csv_"+std::to_string(RunGroup)+"_D2_neg_exc_norad.inp";
  std::string ofs_D2_neg_exc_rad_name = "/u/group/c-csv/hdbhatt/my_analysis/simulation/simc_oct_2020_ver/simc_gfortran/infiles/csv_"+std::to_string(RunGroup)+"_D2_neg_exc_rad.inp";
  std::string ofs_D2_neg_exc_raddelta_name = "/u/group/c-csv/hdbhatt/my_analysis/simulation/simc_oct_2020_ver/simc_gfortran/infiles/csv_"+std::to_string(RunGroup)+"_D2_neg_exc_raddelta.inp";


  std::string ofs_D2_pos_inc_norad_name = "/u/group/c-csv/hdbhatt/my_analysis/simulation/simc_oct_2020_ver/simc_gfortran/infiles/csv_"+std::to_string(RunGroup)+"_D2_pos_inc_norad.inp";
  std::string ofs_D2_pos_inc_rad_name = "/u/group/c-csv/hdbhatt/my_analysis/simulation/simc_oct_2020_ver/simc_gfortran/infiles/csv_"+std::to_string(RunGroup)+"_D2_pos_inc_rad.inp";
  std::string ofs_D2_pos_exc_norad_name = "/u/group/c-csv/hdbhatt/my_analysis/simulation/simc_oct_2020_ver/simc_gfortran/infiles/csv_"+std::to_string(RunGroup)+"_D2_pos_exc_norad.inp";
  std::string ofs_D2_pos_exc_rad_name = "/u/group/c-csv/hdbhatt/my_analysis/simulation/simc_oct_2020_ver/simc_gfortran/infiles/csv_"+std::to_string(RunGroup)+"_D2_pos_exc_rad.inp";
  std::string ofs_D2_pos_exc_raddelta_name = "/u/group/c-csv/hdbhatt/my_analysis/simulation/simc_oct_2020_ver/simc_gfortran/infiles/csv_"+std::to_string(RunGroup)+"_D2_pos_exc_raddelta.inp";
 ...
 std::ofstream ofs_D2_neg_exc_raddelta;
  ofs_D2_neg_exc_raddelta.open(ofs_D2_neg_exc_raddelta_name.c_str());
 ...
 std::ofstream ofs_D2_pos_exc_raddelta;
  ofs_D2_pos_exc_raddelta.open(ofs_D2_pos_exc_raddelta_name.c_str());
  ...
  ofs_D2_neg_inc_norad<<" targ%mass_amu = 2.014101"<<std::endl;
  ...
  ofs_D2_neg_inc_rad<<" targ%mass_amu = 2.014101"<<std::endl;
  ...
  ofs_D2_neg_exc_norad<<" which_pion = "<<neg<<std::endl;
  ofs_D2_neg_exc_norad<<" doing_delta = 0"<<std::endl;
  ofs_D2_neg_exc_norad<<" doing_rho = 0"<<std::endl;
  ofs_D2_neg_exc_norad<<" doing_semi = "<<exc<<std::endl;
  ...
  ofs_D2_neg_exc_norad<<" using_first_cer = 1"<<std::endl;
  ...
  ofs_D2_neg_exc_norad<<" targ%mass_amu = 2.014101"<<std::endl;
  ...
  ofs_D2_neg_exc_norad<<" targ%Bangle = 80.0"<<std::endl;
  ofs_D2_neg_exc_norad<<" targ%Bphi = 270"<<std::endl;
  ofs_D2_neg_exc_norad<<" targ%pol = 1.0"<<std::endl;
  ofs_D2_neg_exc_norad<<"end parm beamandtargetinfo\n"<<std::endl;
  
  ofs_D2_neg_exc_norad<<"begin parm spect_offset"<<std::endl;
  ofs_D2_neg_exc_norad<<" spec%e%offset%x = 0."<<std::endl;
  ofs_D2_neg_exc_norad<<" spec%e%offset%y = 0."<<std::endl;
  ofs_D2_neg_exc_norad<<" spec%e%offset%z = 0."<<std::endl;
  ofs_D2_neg_exc_norad<<" spec%e%offset%xptar = 0."<<std::endl;
  ofs_D2_neg_exc_norad<<" spec%e%offset%yptar = 0."<<std::endl;
  ofs_D2_neg_exc_norad<<" spec%p%offset%x = 0."<<std::endl;
  ofs_D2_neg_exc_norad<<" spec%p%offset%y = 0."<<std::endl;
  ofs_D2_neg_exc_norad<<" spec%p%offset%z = 0."<<std::endl;
  ofs_D2_neg_exc_norad<<" spec%p%offset%xptar = 0."<<std::endl;
  ofs_D2_neg_exc_norad<<" spec%p%offset%yptar = 0."<<std::endl;
  ofs_D2_neg_exc_norad<<"end parm spect_offset"<<std::endl;


  ofs_D2_neg_exc_norad<<"begin parm simulate"<<std::endl;
  ofs_D2_neg_exc_norad<<" hard_cuts = 0"<<std::endl;
  ofs_D2_neg_exc_norad<<" using_rad = "<<norad<<std::endl;
  ofs_D2_neg_exc_norad<<" using_expon = 0"<<std::endl;
  ofs_D2_neg_exc_norad<<" one_tail = 0"<<std::endl;
  ...
  ofs_D2_neg_exc_norad<<" deForest_flag = 0"<<std::endl;
  ofs_D2_neg_exc_norad<<" rad_flag = 0"<<std::endl;
  ofs_D2_neg_exc_norad<<" extrad_flag = 2"<<std::endl;
  ofs_D2_neg_exc_norad<<" lambda(1) = 0.0"<<std::endl;
  ofs_D2_neg_exc_norad<<" lambda(2) = 0.0"<<std::endl;
  ofs_D2_neg_exc_norad<<" lambda(3) = 0.0"<<std::endl;
  ofs_D2_neg_exc_norad<<" Nntu = 1"<<std::endl;
  ofs_D2_neg_exc_norad<<" using_Coulomb = 1"<<std::endl;
  ofs_D2_neg_exc_norad<<" dE_edge_test = 0"<<std::endl;
  ofs_D2_neg_exc_norad<<" use_offshell_rad = 1"<<std::endl;
  ofs_D2_neg_exc_norad<<" Egamma_gen_max = 0"<<std::endl;
  ofs_D2_neg_exc_norad<<" using_tgt_field= 0"<<std::endl;
  ofs_D2_neg_exc_norad<<" tgt_field_file = trg_field_map.dat"<<std::endl;
  ofs_D2_neg_exc_norad<<" drift_to_cal = 320.0"<<std::endl;
  ofs_D2_neg_exc_norad<<" do_fermi = 0"<<std::endl;
  ofs_D2_neg_exc_norad<<" pt_b_param = 3.8"<<std::endl;
  ofs_D2_neg_exc_norad<<" sigc_flag = 1"<<std::endl;
  ofs_D2_neg_exc_norad<<" sigc_nbin = 10"<<std::endl;
  ofs_D2_neg_exc_norad<<" sigc_kin_min = 0.035"<<std::endl;
  ofs_D2_neg_exc_norad<<" sigc_kin_max = 0.150"<<std::endl;
  ofs_D2_neg_exc_norad<<" sigc_kin_ind = 0.550"<<std::endl;
 ...
 //4 for exclusive rad neg
  ...
  ofs_D2_neg_exc_rad<<" targ%mass_amu = 2.014101"<<std::endl;
  ...
  //5 neg excl rad delta 

  ofs_D2_neg_exc_raddelta<<";This is a CTP file, using info from Run "<<RunNumber<<"\n"<<std::endl;
  ofs_D2_neg_exc_raddelta<<"begin parm experiment"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" ngen = "<<ngen<<std::endl;
  ofs_D2_neg_exc_raddelta<<" EXPER%charge = "<<charge<<std::endl;
  ofs_D2_neg_exc_raddelta<<" doing_phsp = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" doing_kaon = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" doing_pion = 1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" which_pion = "<<negdelta<<std::endl;
  ofs_D2_neg_exc_raddelta<<" doing_delta = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" doing_rho = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" doing_semi = "<<exc<<std::endl;
  ofs_D2_neg_exc_raddelta<<" doing_hplus = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" doing_decay = 1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" ctau = 780.4"<<std::endl;
  ofs_D2_neg_exc_raddelta<<"end parm experiment\n"<<std::endl;

  ofs_D2_neg_exc_raddelta<<"begin parm kinematics_main"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" Ebeam = "<<Ebeam<<std::endl;
  ofs_D2_neg_exc_raddelta<<" dEbeam = "<<dEbeam<<std::endl;
  ofs_D2_neg_exc_raddelta<<" electron_arm =1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" hadron_arm = 5"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" using_first_cer = 1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%e%P = "<<e_momentum<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%e%theta = "<<e_theta<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%p%P = "<<p_momentum<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%p%theta = "<<p_theta<<std::endl;
  ofs_D2_neg_exc_raddelta<<"end parm kinematics_main\n"<<std::endl;
  
  ofs_D2_neg_exc_raddelta<<"begin parm target"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%A = 2.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%Z = 1.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%mass_amu = 2.014101"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%mrec_amu = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%rho = 0.1668"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%thick = 1668"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%angle = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%abundancy = 100"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%can = 1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<"end parm target\n"<<std::endl;
  
  ofs_D2_neg_exc_raddelta<<"begin parm debug"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" debug(1) = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" debug(2) = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" debug(3) = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" debug(4) = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" debug(5) = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<"end parm debug\n"<<std::endl;
 
  ofs_D2_neg_exc_raddelta<<"begin parm e_arm_accept"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" SPedge%e%delta%min = -15.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" SPedge%e%delta%max = 15.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" SPedge%e%yptar%min = -100.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" SPedge%e%yptar%max = 100.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" SPedge%e%xptar%min = -100.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" SPedge%e%xptar%max = 100.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<"end parm e_arm_accept\n"<<std::endl;

  ofs_D2_neg_exc_raddelta<<"begin parm p_arm_accept"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" SPedge%p%delta%min = -15.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" SPedge%p%delta%max = 30.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" SPedge%p%yptar%min = -100.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" SPedge%p%yptar%max = 100.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" SPedge%p%xptar%min = -100.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" SPedge%p%xptar%max = 100.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<"end parm p_arm_accept\n"<<std::endl;

  ofs_D2_neg_exc_raddelta<<"begin parm beamandtargetinfo"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" gen%xwid = 0.008868"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" gen%ywid = 0.004235"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%fr_pattern = 3"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%fr1 = 0.1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%fr2 = 0.1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%xoffset = 0.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%yoffset = 0.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%zoffset = 0.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%Bangle = 80.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%Bphi = 270"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" targ%pol = 1.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<"end parm beamandtargetinfo\n"<<std::endl;
  
  ofs_D2_neg_exc_raddelta<<"begin parm spect_offset"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%e%offset%x = 0."<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%e%offset%y = 0."<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%e%offset%z = 0."<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%e%offset%xptar = 0."<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%e%offset%yptar = 0."<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%p%offset%x = 0."<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%p%offset%y = 0."<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%p%offset%z = 0."<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%p%offset%xptar = 0."<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spec%p%offset%yptar = 0."<<std::endl;
  ofs_D2_neg_exc_raddelta<<"end parm spect_offset"<<std::endl;


  ofs_D2_neg_exc_raddelta<<"begin parm simulate"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" hard_cuts = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" using_rad= "<<rad<<std::endl;
  ofs_D2_neg_exc_raddelta<<" using_expon = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" one_tail = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" intcor_mode = 1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" spect_mode = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" cuts%Em%min = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" cuts%Em%max = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" using_Eloss = 1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" correct_Eloss = 1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" correct_raster = 1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" mc_smear = 1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" deForest_flag = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" rad_flag = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" extrad_flag = 2"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" lambda(1) = 0.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" lambda(2) = 0.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" lambda(3) = 0.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" Nntu = 1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" using_Coulomb = 1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" dE_edge_test = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" use_offshell_rad= 1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" Egamma_gen_max = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" using_tgt_field= 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" tgt_field_file = trg_field_map.dat"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" drift_to_cal = 320.0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" do_fermi = 0"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" pt_b_param = 3.8"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" sigc_flag = 1"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" sigc_nbin = 10"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" sigc_kin_min = 0.035"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" sigc_kin_max = 0.150"<<std::endl;
  ofs_D2_neg_exc_raddelta<<" sigc_kin_ind = 0.550"<<std::endl;
  
  ofs_D2_neg_exc_raddelta<<"end parm simulate\n"<<std::endl;

  ofs_D2_neg_exc_raddelta.close();

  //////neg done 5 files  
  
  //1 Pos started for pi+ norad
  ...
  ofs_D2_pos_inc_norad<<" targ%mass_amu = 2.014101"<<std::endl;
  ...
  ofs_D2_pos_inc_rad<<" targ%mass_amu = 2.014101"<<std::endl;
  ...
  ofs_D2_pos_exc_norad<<" which_pion = "<<pos<<std::endl;
  ...
  ofs_D2_pos_exc_norad<<" using_first_cer = 1"<<std::endl;
  ...
  ofs_D2_pos_exc_norad<<" targ%mass_amu = 2.014101"<<std::endl;
  ...
  ofs_D2_pos_exc_norad<<" targ%Bangle = 80.0"<<std::endl;
  ofs_D2_pos_exc_norad<<" targ%Bphi = 270"<<std::endl;
  ofs_D2_pos_exc_norad<<" targ%pol = 1.0"<<std::endl;
  ofs_D2_pos_exc_norad<<"end parm beamandtargetinfo\n"<<std::endl;
  
  ofs_D2_pos_exc_norad<<"begin parm spect_offset"<<std::endl;
  ofs_D2_pos_exc_norad<<" spec%e%offset%x = 0."<<std::endl;
  ofs_D2_pos_exc_norad<<" spec%e%offset%y = 0."<<std::endl;
  ofs_D2_pos_exc_norad<<" spec%e%offset%z = 0."<<std::endl;
  ofs_D2_pos_exc_norad<<" spec%e%offset%xptar = 0."<<std::endl;
  ofs_D2_pos_exc_norad<<" spec%e%offset%yptar = 0."<<std::endl;
  ofs_D2_pos_exc_norad<<" spec%p%offset%x = 0."<<std::endl;
  ofs_D2_pos_exc_norad<<" spec%p%offset%y = 0."<<std::endl;
  ofs_D2_pos_exc_norad<<" spec%p%offset%z = 0."<<std::endl;
  ofs_D2_pos_exc_norad<<" spec%p%offset%xptar = 0."<<std::endl;
  ofs_D2_pos_exc_norad<<" spec%p%offset%yptar = 0."<<std::endl;
  ofs_D2_pos_exc_norad<<"end parm spect_offset"<<std::endl;


  ofs_D2_pos_exc_norad<<"begin parm simulate"<<std::endl;
  ofs_D2_pos_exc_norad<<" hard_cuts = 0"<<std::endl;
  ofs_D2_pos_exc_norad<<" using_rad = "<<norad<<std::endl;
  ofs_D2_pos_exc_norad<<" using_expon = 0"<<std::endl;
  ofs_D2_pos_exc_norad<<" one_tail = 0"<<std::endl;
  ...
  ofs_D2_pos_exc_norad<<" deForest_flag = 0"<<std::endl;
  ofs_D2_pos_exc_norad<<" rad_flag = 0"<<std::endl;
  ofs_D2_pos_exc_norad<<" extrad_flag = 2"<<std::endl;
  ofs_D2_pos_exc_norad<<" lambda(1) = 0.0"<<std::endl;
  ofs_D2_pos_exc_norad<<" lambda(2) = 0.0"<<std::endl;
  ofs_D2_pos_exc_norad<<" lambda(3) = 0.0"<<std::endl;
  ofs_D2_pos_exc_norad<<" Nntu = 1"<<std::endl;
  ofs_D2_pos_exc_norad<<" using_Coulomb = 1"<<std::endl;
  ofs_D2_pos_exc_norad<<" dE_edge_test = 0"<<std::endl;
  ofs_D2_pos_exc_norad<<" use_offshell_rad = 1"<<std::endl;
  ofs_D2_pos_exc_norad<<" Egamma_gen_max = 0"<<std::endl;
  ofs_D2_pos_exc_norad<<" using_tgt_field= 0"<<std::endl;
  ofs_D2_pos_exc_norad<<" tgt_field_file = trg_field_map.dat"<<std::endl;
  ofs_D2_pos_exc_norad<<" drift_to_cal = 320.0"<<std::endl;
  ofs_D2_pos_exc_norad<<" do_fermi = 0"<<std::endl;
  ofs_D2_pos_exc_norad<<" pt_b_param = 3.8"<<std::endl;
  ofs_D2_pos_exc_norad<<" sigc_flag = 1"<<std::endl;
  ofs_D2_pos_exc_norad<<" sigc_nbin = 10"<<std::endl;
  ofs_D2_pos_exc_norad<<" sigc_kin_min = 0.035"<<std::endl;
  ofs_D2_pos_exc_norad<<" sigc_kin_max = 0.150"<<std::endl;
  ofs_D2_pos_exc_norad<<" sigc_kin_ind = 0.550"<<std::endl;
  
  ofs_D2_pos_exc_norad<<"end parm simulate\n"<<std::endl;

  ofs_D2_pos_exc_norad.close();
  /////////////////
 // 4 pos for exclusive, norad
  ...
  ofs_D2_pos_exc_rad<<" doing_hplus = 0"<<std::endl;
  ...
  ofs_D2_pos_exc_rad<<" targ%mass_amu = 2.014101"<<std::endl;
  ...
  // 5 pos for exclusive, norad
  ofs_D2_pos_exc_raddelta<<";This is a CTP file, using info from Run "<<RunNumber<<"\n"<<std::endl;
  ofs_D2_pos_exc_raddelta<<"begin parm experiment"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" ngen = "<<ngen<<std::endl;
  ofs_D2_pos_exc_raddelta<<" EXPER%charge = "<<charge<<std::endl;
  ofs_D2_pos_exc_raddelta<<" doing_phsp = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" doing_kaon = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" doing_pion = 1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" which_pion = "<<posdelta<<std::endl;
  ofs_D2_pos_exc_raddelta<<" doing_delta = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" doing_rho = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" doing_semi = "<<exc<<std::endl;
  ofs_D2_pos_exc_raddelta<<" doing_hplus = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" doing_decay = 1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" ctau = 780.4"<<std::endl;
  ofs_D2_pos_exc_raddelta<<"end parm experiment\n"<<std::endl;

  ofs_D2_pos_exc_raddelta<<"begin parm kinematics_main"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" Ebeam = "<<Ebeam<<std::endl;
  ofs_D2_pos_exc_raddelta<<" dEbeam = "<<dEbeam<<std::endl;
  ofs_D2_pos_exc_raddelta<<" electron_arm =1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" hadron_arm = 5"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" using_first_cer = 1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%e%P = "<<e_momentum<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%e%theta = "<<e_theta<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%p%P = "<<p_momentum<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%p%theta = "<<p_theta<<std::endl;
  ofs_D2_pos_exc_raddelta<<"end parm kinematics_main\n"<<std::endl;
  
  ofs_D2_pos_exc_raddelta<<"begin parm target"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%A = 2.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%Z = 1.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%mass_amu = 2.014101"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%mrec_amu = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%rho = 0.1668"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%thick = 1668"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%angle = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%abundancy = 100"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%can = 1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<"end parm target\n"<<std::endl;
  
  ofs_D2_pos_exc_raddelta<<"begin parm debug"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" debug(1) = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" debug(2) = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" debug(3) = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" debug(4) = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" debug(5) = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<"end parm debug\n"<<std::endl;
 
  ofs_D2_pos_exc_raddelta<<"begin parm e_arm_accept"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" SPedge%e%delta%min = -15.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" SPedge%e%delta%max = 15.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" SPedge%e%yptar%min = -100.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" SPedge%e%yptar%max = 100.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" SPedge%e%xptar%min = -100.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" SPedge%e%xptar%max = 100.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<"end parm e_arm_accept\n"<<std::endl;

  ofs_D2_pos_exc_raddelta<<"begin parm p_arm_accept"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" SPedge%p%delta%min = -15.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" SPedge%p%delta%max = 30.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" SPedge%p%yptar%min = -100.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" SPedge%p%yptar%max = 100.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" SPedge%p%xptar%min = -100.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" SPedge%p%xptar%max = 100.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<"end parm p_arm_accept\n"<<std::endl;

  ofs_D2_pos_exc_raddelta<<"begin parm beamandtargetinfo"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" gen%xwid = 0.008868"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" gen%ywid = 0.004235"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%fr_pattern = 3"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%fr1 = 0.1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%fr2 = 0.1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%xoffset = 0.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%yoffset = 0.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%zoffset = 0.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%Bangle = 80.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%Bphi = 270"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" targ%pol = 1.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<"end parm beamandtargetinfo\n"<<std::endl;
  
  ofs_D2_pos_exc_raddelta<<"begin parm spect_offset"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%e%offset%x = 0."<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%e%offset%y = 0."<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%e%offset%z = 0."<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%e%offset%xptar = 0."<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%e%offset%yptar = 0."<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%p%offset%x = 0."<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%p%offset%y = 0."<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%p%offset%z = 0."<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%p%offset%xptar = 0."<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spec%p%offset%yptar = 0."<<std::endl;
  ofs_D2_pos_exc_raddelta<<"end parm spect_offset"<<std::endl;


  ofs_D2_pos_exc_raddelta<<"begin parm simulate"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" hard_cuts = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" using_rad = "<<rad<<std::endl;
  ofs_D2_pos_exc_raddelta<<" using_expon = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" one_tail = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" intcor_mode = 1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" spect_mode = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" cuts%Em%min = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" cuts%Em%max = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" using_Eloss = 1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" correct_Eloss = 1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" correct_raster = 1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" mc_smear = 1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" deForest_flag = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" rad_flag = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" extrad_flag = 2"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" lambda(1) = 0.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" lambda(2) = 0.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" lambda(3) = 0.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" Nntu = 1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" using_Coulomb = 1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" dE_edge_test = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" use_offshell_rad = 1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" Egamma_gen_max = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" using_tgt_field= 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" tgt_field_file = trg_field_map.dat"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" drift_to_cal = 320.0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" do_fermi = 0"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" pt_b_param = 3.8"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" sigc_flag = 1"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" sigc_nbin = 10"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" sigc_kin_min = 0.035"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" sigc_kin_max = 0.150"<<std::endl;
  ofs_D2_pos_exc_raddelta<<" sigc_kin_ind = 0.550"<<std::endl;
  
  ofs_D2_pos_exc_raddelta<<"end parm simulate\n"<<std::endl;

  ofs_D2_pos_exc_raddelta.close();
  //////// pos done
